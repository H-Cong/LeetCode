class Trie:
    ...
    def search(self, word: str) -> bool:
        ...
        """
        p = self.find(word)
        # if p and p['#']: return True # you can use p['#'] here as if the word is apple
                                     # and you search(app), then p = {'l': {'e': {'#': True}}}
                                     # this will throw a key error as '#' is not a existed key
